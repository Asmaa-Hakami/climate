                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              width: MediaQuery.of(context).size.width * 0.9,
                              child: Text(
                                '${AllDates.hdate} ${AllDates.hMonth}، ${AllDates.hYear}',
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 15,
                                    fontFamily: 'ArbFONTS'),
                      ...
                      onTap: () {
                        setState(() {
                          if (myController.text != '') {
                            myController.text =
                                AllDates().toEngNum(myController.text);
                    ...
                    children: [
                      const Text('العام:  ',
                          style: TextStyle(
                              ...
                              height: 1.3)),
                      Text(
                        AllDates.replaceEngNumber(year),
                        style: const TextStyle(
                            height: 1, fontSize: 18, color: Color(0xFF506B75)),
                      ),
                    ],
                  ),
                  const Text('دخول شهر رمضان',
                      style: TextStyle(
                        color: Color(0xFF5D5C5D),
                        fontSize: 20,
