...
import 'package:climate_calendar_new/utils/widget_helper.dart';
        ...
        children: <Widget>[
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: TextScaleFactorClamper(
                      ...
                      textScaleFactor: 1.0,
                      style: TextStyle(color: Color(0xff506B75), fontSize: 30),
                    ),
                  )),
                  TextScaleFactorClamper(
                              child:Text(
                      AllDates.replaceEngNumber(format.format(
                          now)), //format.format(now) //'${alarm!.hour}:${alarm!.minute}'
                      textScaleFactor: 1.0,
          ...
          GestureDetector(
              ...
              child: Stack(alignment: Alignment.center, children: [
                Image(
                  image: AssetImage('assets/images/snooze_box.png'),
